...
//Reed Switches:  wire 5v to one end - other end to pin#X AND 10K Ohm   resister to gnd
// LED: wire anode to 13 - anode to 82 or 220 Ohm resistor (check the LED) and gnd
...
//int glyphOrder[] = {4,12,11,7,4}; //7,the code = order of reedSwitchPins
...
Serial.print("solenoidState Before = ");
Serial.print(solenoidState);
Serial.print("      ");

            solenoidState =! solenoidState;  //open or close the solenoid possibly later
            digitalWrite(solenoidPin,solenoidState);

Serial.print("solenoidState After = ");
Serial.print(solenoidState);
Serial.print("      ");
Serial.println();
